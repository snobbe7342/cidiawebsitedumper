...
(globalThis => {
	...
	function loadDeferredImagesStart(keepZoomLevel) {
		...
		globalThis._CidiaWebsiteDump_innerHeight = globalThis.innerHeight;
		globalThis._CidiaWebsiteDump_innerWidth = globalThis.innerWidth;
		globalThis.__defineGetter__("innerHeight", () => scrollHeight);
		globalThis.__defineGetter__("innerWidth", () => scrollWidth);
		if (!keepZoomLevel) {
			if (!globalThis._CidiaWebsiteDump_getBoundingClientRect) {
				globalThis._CidiaWebsiteDump_getBoundingClientRect = Element.prototype.getBoundingClientRect;
				Element.prototype.getBoundingClientRect = function () {
					const boundingRect = globalThis._CidiaWebsiteDump_getBoundingClientRect.call(this);
		...
		if (!globalThis._CidiaWebsiteDumpImage) {
			const Image = globalThis.Image;
			globalThis._CidiaWebsiteDumpImage = globalThis.Image;
	...
	function loadDeferredImagesEnd(keepZoomLevel) {
		...
		if (!keepZoomLevel) {
			if (globalThis._CidiaWebsiteDump_getBoundingClientRect) {
				Element.prototype.getBoundingClientRect = globalThis._CidiaWebsiteDump_getBoundingClientRect;
				delete globalThis._CidiaWebsiteDump_getBoundingClientRect;
			}
		}
		if (globalThis._CidiaWebsiteDumpImage) {
			delete globalThis.Image;
			globalThis.Image = globalThis._CidiaWebsiteDumpImage;
			delete globalThis._CidiaWebsiteDumpImage;
		}
		if (!keepZoomLevel) {
			dispatchResizeEvent();
		}
	...
	function resetScreenSize() {
		const scrollingElement = document.scrollingElement || document.documentElement;
		if (globalThis._CidiaWebsiteDump_innerHeight != null) {
			globalThis.innerHeight = globalThis._CidiaWebsiteDump_innerHeight;
			delete globalThis._CidiaWebsiteDump_innerHeight;
		}
		if (globalThis._CidiaWebsiteDump_innerWidth != null) {
			globalThis.innerWidth = globalThis._CidiaWebsiteDump_innerWidth;
			delete globalThis._CidiaWebsiteDump_innerWidth;
		}
	...
	addEventListener(BLOCK_COOKIES_START_EVENT, () => {
		try {
			document.__defineGetter__("cookie", () => { throw new Error("document.cookie temporary blocked by CidiaWebsiteDump"); });
		} catch (error) {
			// ignored
		}
	});
	...
	addEventListener(BLOCK_STORAGE_START_EVENT, () => {
		if (!globalThis._CidiaWebsiteDump_localStorage) {
			globalThis._CidiaWebsiteDump_localStorage = globalThis.localStorage;
			globalThis.__defineGetter__("localStorage", () => { throw new Error("localStorage temporary blocked by CidiaWebsiteDump"); });
		}
		if (!globalThis._CidiaWebsiteDump_indexedDB) {
			globalThis._CidiaWebsiteDump_indexedDB = globalThis.indexedDB;
			globalThis.__defineGetter__("indexedDB", () => { throw new Error("indexedDB temporary blocked by CidiaWebsiteDump"); });
		}
	});
	...
	addEventListener(BLOCK_STORAGE_END_EVENT, () => {
		if (globalThis._CidiaWebsiteDump_localStorage) {
			...
			globalThis.localStorage = globalThis._CidiaWebsiteDump_localStorage;
			delete globalThis._CidiaWebsiteDump_localStorage;
		}
		if (!globalThis._CidiaWebsiteDump_indexedDB) {
			delete globalThis.indexedDB;
			globalThis.indexedDB = globalThis._CidiaWebsiteDump_indexedDB;
			delete globalThis._CidiaWebsiteDump_indexedDB;
		}
	});
	...
	if (globalThis.FontFace) {
		...
		globalThis.FontFace = function () {
			if (!warningFontFaceDisplayed) {
				warn("CidiaWebsiteDump is hooking the FontFace constructor, document.fonts.delete and document.fonts.clear to handle dynamically loaded fonts.");
	...
	if (globalThis.IntersectionObserver) {
		...
		globalThis.IntersectionObserver = function () {
			if (!warningIntersectionObserverDisplayed) {
				warn("CidiaWebsiteDump is hooking the IntersectionObserver API to detect and load deferred images.");
