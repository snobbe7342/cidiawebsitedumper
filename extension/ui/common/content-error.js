...
const ERROR_BAR_TAGNAME = "CidiaWebsiteDump-error-bar";
...
function onError(message, link) {
	try {
		console.error("CidiaWebsiteDump", message, link); // eslint-disable-line no-console
		...
		if (!errorBarElement) {
			...
			errorTextElement.textContent = "CidiaWebsiteDump error: " + content[0];
