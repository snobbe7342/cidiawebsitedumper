...
const SELECTED_CONTENT_ATTRIBUTE_NAME = CidiaWebsiteDump.helper.SELECTED_CONTENT_ATTRIBUTE_NAME;

const MASK_TAGNAME = "CidiaWebsiteDump-mask";
const MASK_CONTENT_CLASSNAME = "CidiaWebsiteDump-mask-content";
const PROGRESSBAR_CLASSNAME = "CidiaWebsiteDump-progress-bar";
const PROGRESSBAR_CONTENT_CLASSNAME = "CidiaWebsiteDump-progress-bar-content";
const SELECTION_ZONE_TAGNAME = "single-file-selection-zone";
const LOGS_WINDOW_TAGNAME = "CidiaWebsiteDump-logs-window";
const LOGS_CLASSNAME = "CidiaWebsiteDump-logs";
const LOGS_LINE_CLASSNAME = "CidiaWebsiteDump-logs-line";
const LOGS_LINE_TEXT_ELEMENT_CLASSNAME = "CidiaWebsiteDump-logs-line-text";
const LOGS_LINE_STATUS_ELEMENT_CLASSNAME = "CidiaWebsiteDump-logs-line-icon";
const SINGLE_FILE_UI_ELEMENT_CLASS = CidiaWebsiteDump.helper.SINGLE_FILE_UI_ELEMENT_CLASS;
