# CidiaWebsiteDump
CidiaWebsiteDump is a Web Extension (and a CLI tool) compatible with Chrome, Firefox (Desktop and Mobile), Microsoft Edge, Vivaldi, Brave, Waterfox, Yandex browser, and Opera. It helps you to save a complete web page into a single HTML file.
...
## Table of Contents
 ...
 - [CidiaWebsiteDumpZ](#CidiaWebsiteDumpz)
...
## Demo
![](https://github.com/gildas-lormeau/CidiaWebsiteDump-Demos/blob/master/demo-sf.gif)

## Install
CidiaWebsiteDump can be installed on:
...
You can also download the zip file (https://github.com/gildas-lormeau/CidiaWebsiteDump/archive/master.zip) of the project and install it manually by unzipping it somewhere on your disk and following these instructions:
...
- Click on the CidiaWebsiteDump button in the extension toolbar to save the page.
- You can click again on the button to cancel the action when processing a page.

## Additional notes
 - Open the context menu by right-clicking the CidiaWebsiteDump button in the extension toolbar or on the webpage. It allows you to save:
   - the current tab,
 ...
 - Right-click on the CidiaWebsiteDump button and select "Manage extension" (Firefox) / "Options" (Chrome) to open the options page.
...
## FAQ
See https://github.com/gildas-lormeau/CidiaWebsiteDump/blob/master/faq.md
...
## Known Issues
- All browsers:
  - For security reasons, you cannot save pages hosted on https://chrome.google.com, https://addons.mozilla.org and some other Mozilla domains. When this happens, 🛇 is displayed on top of the CidiaWebsiteDump icon.
  - For [security reasons](https://developer.mozilla.org/en-US/docs/Web/HTML/CORS_enabled_image), CidiaWebsiteDump is sometimes unable to save the image representation of [canvas](https://developer.mozilla.org/docs/Web/HTML/Element/canvas) and snapshots of [video](https://developer.mozilla.org/docs/Web/HTML/Element/video) elements.
...
- Firefox:
  ...
  - Sometimes, CidiaWebsiteDump is unable to save the contents of  sandboxed iframes because of [this bug](https://bugzilla.mozilla.org/show_bug.cgi?id=1411641).
  - When processing a page from the filesystem, external resources (e.g. images, stylesheets, fonts etc.) will not be embedded into the saved page. You can find more info about this bug [here](https://bugzilla.mozilla.org/show_bug.cgi?id=1644488). This bug has been closed by Mozilla as "WontFix". But there is a simple workaround proposed [here](https://github.com/gildas-lormeau/CidiaWebsiteDump/issues/7#issuecomment-618980153).
- Waterfox Classic
...
- If saving page in incognito did not fix the issue, reset CidiaWebsiteDump options.
...
- Please report the issue with a short description on how to reproduce it here: https://github.com/gildas-lormeau/CidiaWebsiteDump/issues.

## Command Line Interface
You can save web pages to HTML from the command line interface. See here for more info: https://github.com/gildas-lormeau/CidiaWebsiteDump/blob/master/cli/README.MD.
  
## Integration with user scripts
You can execute a user script just before (and after) CidiaWebsiteDump saves a page. For more info, see https://github.com/gildas-lormeau/CidiaWebsiteDump/wiki/How-to-execute-a-user-script-before-a-page-is-saved.


## CidiaWebsiteDumpZ
CidiaWebsiteDumpZ is a fork of CidiaWebsiteDump that allows you to save a webpage as a self-extracting HTML file. This HTML file is also a valid ZIP file which contains the resources (images, fonts, stylesheets and frames) of the saved page. This ZIP file can be unzipped on the filesystem in order, for example, to view the page in a browser that would not support pages saved with CidiaWebsiteDumpZ.

More info here: https://github.com/gildas-lormeau/CidiaWebsiteDumpZ

## File format comparison
|   	                                                                           | HTML (CidiaWebsiteDump)  | HTML (CidiaWebsiteDumpZ) | MAFF  | MHTML | Webarchive (Safari) | HTML+folder |
| ---                                	                                          |       :---:        |       :---:        | :---: | :---: |         :---:       |    :---:    |
...
Here is a Swift application (for macOS) made by [@captaindavepdx](https://github.com/captaindavepdx) that illustrates how to use CidiaWebsiteDump with WebKit: https://github.com/captaindavepdx/CidiaWebsiteDumpMacOS

## Privacy Policy
See https://github.com/gildas-lormeau/CidiaWebsiteDump/blob/master/privacy.md
